...
return [
    ...
    */
    ...
    'logo' => '<b>ENSAM</b>',
    'logo_img' => 'https://yt3.googleusercontent.com/u1_lwLxT376fx_y5EqPmbyA43r5zQMHu_yp0PhdU6UBI_jvZ-XtE0nwgkRt93MO1HnQU1yPF7w=s900-c-k-c0x00ffffff-no-rj',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Listes etudiants',
                    'url'  => 'admin/etudiants',
                    'icon' => 'fas fa-fw fa-list',
                ],
             
                [
                    'text' => 'etudiant affecters',
                    'url'  => 'admin/accept-student',
                    'icon' => 'fas fa-fw fa-user',
                ],
                [
                    'text' => 'chambres',
                    'url'  => 'admin/chambres',
                    'icon' => 'fas fa-fw fas fa-hotel',
                ],
